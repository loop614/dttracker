 ...
 */
final class Version20230726203257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expense (id INT NOT NULL, user_id INT DEFAULT NULL, category_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, amount NUMERIC(7, 3) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tracker_user (id INT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
